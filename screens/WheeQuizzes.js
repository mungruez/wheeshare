...
const styles = StyleSheet.create({
  ...
  vcDropdownContainer: { width: '95%', maxHeight: height * 0.2, alignSelf: 'center', backgroundColor: '#1e293b', borderRadius: 10, padding: 10, marginBottom: 8, borderWidth: 1, borderColor: '#990f0f' },
  vcInfoLabel: { color: '#ca3838', fontSize: 12, fontWeight: 'bold', textAlign: 'center', marginBottom: 6 },
  ...
  changeTypeIcon: { fontSize: 14, fontWeight: 'bold', color: '#ca3838' },
  ...
  optionPlayButtonChosen: { backgroundColor: 'rgba(202, 56, 56, 0.25)', borderColor: '#990f0f' },
  optionPlayText: { color: '#fff', fontSize: 13 },
  optionPlayTextChosen: { color: '#ca3838', fontWeight: 'bold' },
