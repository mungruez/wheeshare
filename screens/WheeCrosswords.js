...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 2.5, borderColor: '#12863f', borderRadius: 12, padding: 5, marginTop: 7, backgroundColor: 'rgba(224, 255, 217, 0.86))', opacity: 1, fontWeight: "bold", fontSize: 13 },
